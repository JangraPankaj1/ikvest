                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-5">
                            <div class="right-login-form">
                                ...
                                <form id = "thisForm"  class="formRegister" action="{{ route('event.post') }}" method="post"  enctype="multipart/form-data">
                                    @csrf

                                    <div class="sign-up-form">

                                        <label>Event Name
                                                <input type="text" name="event_name" placeholder="Event Name" class="form-control" value="{{ old('event_name') }}"
                                                />
                                             <div class="error">
                                                @error('event_name')
                                                    {{ $message }}
                                     ...
                                     <label>Date & Time
                                     <input type="datetime-local" id="dateTime" name="Date_time" class="form-control"  value="{{ old('Date_time') }}">
                                     <div class="error">
                                                @error('event_name')
                                                    {{ $message }}
                                                @enderror
                                        ...
                                        <label>Place & location
                                            <input type="text" placeholder="Place" name="placeLocation" class="form-control"
                                             />  
                                             <div class="error">
                                                @error('placeLocation')
                                                    {{ $message }}
